...
<template>
  <div :dir="dir" :class="dropdownClasses" class="dropdown v-select">
    <div ref="toggle" class="dropdown-toggle" @mousedown.prevent="toggleDropdown">
      <div ref="selectedOptions" class="vs__selected-options">
        ...
        >
          <span :key="option.index" class="selected-tag">
            <slot
      ...
      <div class="vs__actions">
        ...
        <slot name="spinner">
          <div v-show="mutableLoading" class="spinner">Loading...</div>
        </slot>
      </div>
    </div>
